...
hexversion, version_info  = version_info(2,1,2,'',0)
...
description     = 'SALI is used to image and install Linux machine with rsync or bittorrent, see https://gitlab.com/surfsara/sali for more information.'
author          = 'SURF'
